...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2024 at 05:53 PM
...
INSERT INTO `brand_profile` (`brand_id`, `bg_img`, `logo_img`, `brand_name`, `category`, `register_date`, `location`, `user_name`, `user_email`, `user_phone`, `gender`, `brand_descr`, `fb_url`, `insta_url`, `youtube_url`, `website_url`) VALUES
(1, 'images.jpg', 'img 3.jpg', 'MUSKAN', 'Food', '2024-07-05', 'KARACH', 'MUSKAN', 'muskanmansoor@gmail.com', 32782475, 'Female', 'Enter Your Brand Information', 'http://localhost:82/vission/html/app/profile-edit.php', 'http://localhost:82/vission/html/app/profile-edit.php', 'http://localhost:82/vission/html/app/profile-edit.php', 'http://localhost:82/vission/html/app/profile-edit.php'),
(2, 'im2.jpg', 'images.jpg', 'MUSKAN', 'Food', '2024-07-11', 'KARACH', 'MUSKAN', 'muskanmansoor@gmail.com', 32782475, 'Female', 'Enter Your Brand Information', 'http://localhost:82/vission/html/app/profile-edit.php', 'http://localhost:82/vission/html/app/profile-edit.php', 'http://localhost:82/vission/html/app/profile-edit.php', 'http://localhost:82/vission/html/app/profile-edit.php');
